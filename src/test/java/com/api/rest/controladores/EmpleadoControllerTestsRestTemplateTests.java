...
public class EmpleadoControllerTestsRestTemplateTests {
    ...
    void testEliminarEmpleado(){
        ...
        ResponseEntity<Empleado> respuestaDetalle = testRestTemplate.getForEntity("http://localhost:8080/api/empleados/1", Empleado.class);
